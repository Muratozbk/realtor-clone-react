...
export default function Listing() {
    ...
    return (
        <main>
            ...
            <div className="fixed top-[13%] right-[3%] z-10 cursor-pointer bg-white border-2 border-gray-400 rounded-full w-12 h-12 flex justify-center items-center">
                <FaShare onClick={() => {
            ...
            {shareLinkCopied && (
                <p className='fixed top-[23%] right-[3%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 px-2 py-1'>
                    Link Copied</p>
            )}
            ...
            <div className="m-4 flex flex-col md:flex-row max-w-6xl rounded-lg p-4  lg:mx-auto shadow-lg bg-white lg:space-x-5 ">
                <div className=" w-full ">
                    ...
                    <div className="flex justify-start items-center space-x-4 w-[75%] ">
                        ...
                        <p className='w-full max-w-[200px] bg-green-800 p-1 text-white font-semibold text-center shadow-md rounded-md'>{listing.offer && (
                ...
                <div className="w-full h-[200px] md:h-[400px] z-10 overflow-x-hidden mt-5 md:mt-0 md:ml-2">
