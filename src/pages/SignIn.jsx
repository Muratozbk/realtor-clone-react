                ...
                <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                    <form onSubmit={onSubmit}>
                        <input type="email" id='email'
                            ...
                            className='mb-4 w-full px-4 py-2 text-xl text-gray-700 bg-white  border-gray-400 rounded transition ease-in-out' />
                        ...
                        <button
                            className='w-full text-sm font-medium uppercase rounded shadow-md bg-blue-600 text-white px-7 py-3 hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'
